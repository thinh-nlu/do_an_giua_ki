    ...
    <div class="shop-detail-box-main">
        <div class="container">
                    ...
                    <div class="single-product-details">
                        ...
                        <div class="price-box-bar">
                            <div class="cart-and-bay-btn">
                                <a class="btn hvr-hover" href="${pageContext.request.contextPath}/add_cart?id=<%= p1.getId() %>"><i class="fas fa-heart"></i> Mua ngay</a>
                            </div>
                        </div>

                        <div class="add-to-btn">
                            <div class="add-comp">
                                <a class="btn hvr-hover" href="${pageContext.request.contextPath}/add_wishlist?productId=<%= p1.getId() %>"><i class="fas fa-heart"></i> Thêm vào danh sách yêu thích</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row my-lg-3">
                    ...
                    <div class="card-body">
                        <% if (!feedbackDAO.getTop3Feedback(id).isEmpty()) { %>
                        <% for (Feedback feedback : feedbackDAO.getTop3Feedback(id)) { %>
                        <div class="media mb-3">
                                <div class="mr-2">
                                    <img src="images/profile.jpg" class="profile-image">
                                    <h4><%= feedback.getName() %> </h4>
                                </div>

                                <div class="media-body">
                                    <p><%= feedback.getMessage() %></p>
                                    <small class="text-muted">Được đăng vào <%= format.format(feedback.getCreated()) %></small>
                                </div>
                        </div>
                        <hr>
                        <% } %>
            ...
            <% } %>
            <h2>Đánh giá sản phẩm</h2>
            <form id="form" method="post" action="${pageContext.request.contextPath }/product-detail?action=feedback&id=${product.id}">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Họ và Tên" required data-error="Nhập họ tên của bạn">

                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="email" placeholder="Email" id="email" class="form-control" name="email" required data-error="Vui lòng nhập email">
